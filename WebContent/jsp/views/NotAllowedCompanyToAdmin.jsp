...
<s:iterator value="list" var="student">
    <tr>
        ...
        <td><s:form method="post" action="AllowCompany" enctype="multipart/form-data" validate="true">
        <td><s:hidden label="Company User Name" name="companyUserName" value="%{companyUserName}"></s:hidden></td>
         <td><s:hidden label="Company User Name" name="password" value=""></s:hidden></td>
        <td><s:submit value="Allow" ></s:submit></td> 
        </s:form></td>
     
        <td><s:form method="post" action="DeletCompanyNotAllowed" enctype="multipart/form-data" validate="true">
        <td><s:hidden label="Company User Name" name="companyUserName" value="%{companyUserName}"></s:hidden></td>
         <td><s:hidden label="Company User Name" name="password" value=""></s:hidden></td>
