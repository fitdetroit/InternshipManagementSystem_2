...
<div class="content_wrapper">
			<header class="content_header"><h2>Requested companies</h2></header>
			<section>

<table cellpadding="0" cellspacing="0" class="content_table">
			<tr class="table_header">
				<td>No.</td><td>Company Name</td><td>Address</td><td>Company Telephone</td><td>Contact Persion</td><td>Company Web</td><td>Vacan</td><td>Action</td>
...
<s:iterator value="list" var="student">
	<tr>
        ...
        <input type="submit" value="" class="but_view"/>
       	...
       	<s:form method="post" action="AllowCompany" enctype="multipart/form-data" validate="true">
        <s:hidden label="Company User Name" name="companyUserName" value="%{companyUserName}"></s:hidden>
        <s:hidden label="Company User Name" name="password" value=""></s:hidden>
        <input type="submit" value="" class="but_select"/>
        </s:form>
     
        <s:form method="post" action="DeletCompanyNotAllowed" enctype="multipart/form-data" validate="true">
        <s:hidden label="Company User Name" name="companyUserName" value="%{companyUserName}"></s:hidden>
        <s:hidden label="Company User Name" name="password" value=""></s:hidden>
